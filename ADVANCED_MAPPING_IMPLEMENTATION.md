...
- สร้างภาพรวม 53/53, จำนวน Mapping ที่ระบบรู้จริง, จำนวนแถว และจำนวนปัญหาที่กดไปยังรายละเอียดได้
- สงวนคำว่า “Source Coverage” สำหรับค่าที่ตรวจ non-empty source columns ครบทั้งชุดใน Slice 3; ก่อนถึงจุดนั้นให้แสดง “รอการตรวจสอบ” หากยังคำนวณค่าจริงไม่ได้
...
- จำนวนบน Summary ย้อนกลับไปหา Parse/Validate data จริงได้ และยังไม่อ้างว่าเป็น Source Coverage ฉบับสมบูรณ์
